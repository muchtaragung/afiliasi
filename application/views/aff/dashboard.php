<?php $this->load->view('aff/template/header') ?>

<body>
    <div class="container-scroller">
        <!-- partial:partials/_navbar.html -->
        <?php $this->load->view('aff/template/navbar') ?>
        <!-- partial -->
        <div class="container-fluid page-body-wrapper">
            <!-- partial:partials/_sidebar.html -->
            <?php $this->load->view('aff/template/sidebar') ?>
            <!-- partial -->
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-sm-12 mb-4 mb-xl-0">
                            ...
                            <p class="font-weight-normal mb-2 text-muted"><?= date('M d, Y') ?></p>
                        </div>
                    </div>
                    <div class="row mt-3">
                ...
                <?php $this->load->view('aff/template/footer') ?>
                <!-- partial -->
            </div>
            <!-- main-panel ends -->
        </div>
    ...
    <!-- container-scroller -->
    <?php $this->load->view('aff/template/script') ?>
</body>
