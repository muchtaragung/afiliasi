	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<div class="card" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
				<div class="card-body">
					<img class="img-fluid mb-3" src="<?= base_url() ?>assets/images/bg-payment.jpg" alt="" srcset="">
					<div class="row mb-3">
						<div class="col-lg-12 col-12">
							<h4 class="text-center"><b>Product test</b></h4>
						</div>
					</div>
					<button class="btn btn-outline-primary btn-block mt-3" style="margin-bottom: 5%;" data-toggle="modal" data-target="#showDeskripsi">Deskripsi produk</button>
					<div class="row mt-3">
						<div class="col-lg-6 col-6">
							<h6>Nama Afiliasi</h6>
						</div>
						<div class="col-lg-6 col-6">
							<h6 class="float-right">Jessica</h6>
						</div>
					</div>
					<div class="row mt-2">
						<div class="col-lg-6 col-6">
						...
						<div class="col-lg-6 col-6">
							<h6 class="float-right">3 Bulan</h6>
						</div>
					</div>
					...
					<div class="row mt-3">
						...
						<div class="col-lg-6 col-6">
							<h6 class="float-right"><b>Rp. 19.000</b></h6>
						</div>
					</div>
				</div>
			</div>
			<form id="form" class="contact100-form validate-form">
				<div class="card mt-5" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
					<div class="card-body">
						...
						<!-- hidden -->
						<input type="hidden" name="paymentAmount" id="paymentAmount" value="19000">
						<input type="hidden" name="productDetail" id="productDetail" value="Product Test">
					</div>
				</div>
